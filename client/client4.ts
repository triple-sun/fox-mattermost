...
import type { SystemSetting } from '../types/general';
import type {
  Group,
  GroupPatch,
  GroupSyncable,
...
import type { PostActionResponse } from '../types/integration_actions';
import type {
  Command,
  CommandArgs,
  CommandResponse,
...
import type { MfaSecret } from '../types/mfa';
import type {
...
import type { ProductNotices } from '../types/product_notices';
...
import type { CompleteOnboardingRequest } from '../types/setup';
import type {
  GetTeamMembersOpts,
  Team,
  TeamInviteWithError,
...
import type { TermsOfService } from '../types/terms_of_service';
import type {
  UserThreadList,
  UserThread,
  UserThreadWithPost,
...
export default class Client4 {
  ...
  getOptions(options: Options): AxiosRequestConfig {
  ...
  getUserByEmail = (email: string) => {
    return this.doFetch<UserProfile>(`${this.getUsersRoute()}/email/${email}`, {
      method: 'get',
    });
  };
  ...
  getSessions = (userId: string) => {
    return this.doFetch<Session[]>(`${this.getUserRoute(userId)}/sessions`, {
      method: 'get',
    });
  };
  ...
  getChannel = (channelId: string) => {
    return this.doFetch<ServerChannel>(`${this.getChannelRoute(channelId)}`, {
      method: 'get',
    });
  };
  ...
  addToChannels = (userIds: string[], channelId: string, postRootId = '') => {
    this.trackEvent('api', 'api_channels_add_members', {
      channel_id: channelId,
    });
  ...
  searchAllChannels(
    term: string,
    opts: Omit<ChannelSearchOpts, 'page' | 'per_page'> | undefined,
  ): Promise<ChannelWithTeamData[]>;
  searchAllChannels(term: string, opts: ChannelSearchOpts = {}) {
    ...
    let queryParams: { include_deleted?: boolean; system_console?: boolean } = {
      include_deleted: includeDeleted,
    };
    if (nonAdminSearch) {
  ...
  getFileInfosForPost = (postId: string) => {
    return this.doFetch<FileInfo[]>(`${this.getPostRoute(postId)}/files/info`, {
      method: 'get',
    });
  };
  ...
  getPinnedPosts = (channelId: string) => {
    ...
    return this.doFetch<PostList>(`${this.getChannelRoute(channelId)}/pinned`, {
      method: 'get',
    });
  };
  ...
  getPostEditHistory = (postId: string) => {
    return this.doFetch<Post[]>(`${this.getPostRoute(postId)}/edit_history`, {
      method: 'get',
    });
  };
  ...
  getReactionsForPost = (postId: string) => {
    return this.doFetch<Reaction[]>(`${this.getPostRoute(postId)}/reactions`, {
      method: 'get',
    });
  };
  ...
  getMyPreferences = () => {
    return this.doFetch<PreferenceType>(`${this.getPreferencesRoute('me')}`, {
      method: 'get',
    });
  };
  ...
  getCustomEmojiByName = (name: string) => {
    return this.doFetch<CustomEmoji>(`${this.getEmojisRoute()}/name/${name}`, {
      method: 'get',
    });
  };
  ...
  invalidateCaches = () => {
    return this.doFetch<StatusOK>(`${this.getBaseRoute()}/caches/invalidate`, {
      method: 'post',
    });
  };

  recycleDatabase = () => {
    return this.doFetch<StatusOK>(`${this.getBaseRoute()}/database/recycle`, {
      method: 'post',
    });
  };
  ...
  purgeElasticsearchIndexes = (indexes?: string[]) => {
    return this.doFetch<StatusOK>(
      `${this.getBaseRoute()}/elasticsearch/purge_indexes${
        indexes && indexes.length > 0 ? '?index=' + indexes.join(',') : ''
      }`,
      { method: 'post' },
    );
  };
  ...
  getPluginStatuses = () => {
    return this.doFetch<PluginStatus[]>(`${this.getPluginsRoute()}/statuses`, {
      method: 'get',
    });
  };
  ...
  enablePlugin = (pluginId: string) => {
    return this.doFetch<StatusOK>(`${this.getPluginRoute(pluginId)}/enable`, {
      method: 'post',
    });
  };

  disablePlugin = (pluginId: string) => {
    return this.doFetch<StatusOK>(`${this.getPluginRoute(pluginId)}/disable`, {
      method: 'post',
    });
  };
  ...
  getGroupStats = (groupID: string) => {
    return this.doFetch<GroupStats>(`${this.getGroupRoute(groupID)}/stats`, {
      method: 'get',
    });
  };
  ...
  getGroupsByUserId = (userID: string) => {
    return this.doFetch<Group[]>(`${this.getUsersRoute()}/${userID}/groups`, {
      method: 'get',
    });
  };
  ...
  getAllGroupsAssociatedToChannelsInTeam = (
    ...
    return this.doFetch<{
      ...
      `${this.getBaseRoute()}/teams/${teamID}/groups_by_channels${buildQueryString(
        { paginate: false, filter_allow_reference: filterAllowReference },
      )}`,
      { method: 'get' },
    );
  };
  ...
  getCloudProducts = (includeLegacyProducts?: boolean) => {
    ...
    return this.doFetch<Product[]>(`${this.getCloudRoute()}/products${query}`, {
      method: 'get',
    });
  };
  ...
  getSubscription = () => {
    return this.doFetch<Subscription>(`${this.getCloudRoute()}/subscription`, {
      method: 'get',
    });
  };
  ...
  getPostsUsage = () => {
    return this.doFetch<PostsUsageResponse>(`${this.getUsageRoute()}/posts`, {
      method: 'get',
    });
  };

  getFilesUsage = () => {
    return this.doFetch<FilesUsageResponse>(`${this.getUsageRoute()}/storage`, {
      method: 'get',
    });
  };

  getTeamsUsage = () => {
    return this.doFetch<TeamsUsageResponse>(`${this.getUsageRoute()}/teams`, {
      method: 'get',
    });
  };
  ...
  protected doFetch = async <
    ClientDataResponse extends Record<string, any> | void | null,
  >(
    url: string,
    options: Options,
  ): Promise<ClientDataResponse> => {
    const res = await this.doFetchWithResponse<ClientDataResponse>(
      url,
      options,
    );
  ...
  private doFetchWithResponse = async <
    ClientDataResponse extends Record<string, any> | void | null,
  >(
    url: string,
    options: Options,
